  ...
  return (
    <div className="relative top-16">
      {cart.length === 0 ? (
        ...
        <div className="flex main-cart-box w-11/12 gap-6 mx-auto">
          <div className="w-[100%] md:w-[60%]">
            {cart.map((cart) => (
              <Cartlist key={cart.id} item={cart}></Cartlist>
            ))}
          </div>
          <div className="summary fixed right-1 w-[40%] flex flex-col justify-between min-h-[28rem] mt-8">
            <div>
            ...
            <div>
              ...
              <button className="checkout w-[100%] flex justify-center items-center bg-green-700 p-2 text-xl font-bold hover:bg-green-500">
                Checkout
              </button>
            </div>
          </div>
